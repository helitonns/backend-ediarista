...
urlpatterns = [
    ...
    path('usuarios/listar', usuario_views.listar_usuario, name='listar_usuarios'),
    ...
    path('resetar_senha/sucesso', auth_views.PasswordResetDoneView.as_view(), name='resetar_senha_sucessso'),
